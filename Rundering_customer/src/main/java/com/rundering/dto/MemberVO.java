...
public class MemberVO {
   ...
   public MemberVO(String memberNo, String id, String password, String name, String phone, String email, Date registDate,
		Date modifyDate, int enableWhether, String withDrawal, Date lastLogpsnHourLiver, int loginfailCount) {
