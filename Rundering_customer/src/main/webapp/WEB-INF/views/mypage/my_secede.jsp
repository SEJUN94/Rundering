        ...
        <div class="form-group">
            <div class="row ">
                <label for="id" class="col-2">
                    <p style="font-size: 1.5em;">아이디</p>

                </label>
                <div class="col-10">
                    <div class="col-12 row">
                        <div class="form-group col-4">
                            <input type="text" class="form-control" name="ud" id="id" value="idid" disabled>
                        </div>
                ...
                <div class="col-10">
                    <div class="col-12 row">
                        ...
                        <span class="form-group col-2">
                            <button class="btn  float-right" style="border-color: gray  ">탈퇴</button>
                        </span>
                    </div>
                </div>
            </div>
