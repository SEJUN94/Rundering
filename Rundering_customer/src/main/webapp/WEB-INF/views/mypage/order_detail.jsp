		...
		<div class="card ml-3 mr-3">
			...
			<div class="card-body">
				<div class="col-12 mb-3" style="background-color: #82BBD8;">
					<span class="circle" style="margin-left: 85px;"></span> <span
						class="circle"></span> <span class="circle"></span> <span
						class="circle"></span> <span class="circle"></span>
				</div>
			</div>
			<div class="col-12 mb-3">
				<span class="col-3" style="margin-left: 95px;">수거대기</span> <span
					class="col-3" style="margin-left: 175px;">수거중</span> <span
					class="col-3" style="margin-left: 180px;">수거완료</span> <span
					class="col-3" style="margin-left: 175px;">배송중</span> <span
					class="col-3" style="margin-left: 182px;">배송완료</span>
			</div>
		</div>
	</div>
	<div class="col-12"
		style="width: 100%; min-height: 700px; max-height: 600px; margin: 10px auto; display: flex;">

		<div class="card-body col-6 ml-1"
			...
			<div class="card">
				...
				<div class="card-footer clearfix">총 가격 :</div>

			</div>
		</div>
		<div class="col-6"
			style="min-height: 600px; max-height: 600px; flex: 1; width: 50%; box-sizing: border-box;">
			<div
					...
					<div class="direct-chat-messages">
						...
						<div class="direct-chat-msg">
							<div class="direct-chat-infos clearfix">
								<span class="direct-chat-name float-left">고객</span> <span
							...
							<div class="direct-chat-text">옷 깨끗하게 빨아놔라!</div>
						...
						<div class="direct-chat-msg right">
							<div class="direct-chat-infos clearfix">
								<span class="direct-chat-name float-right">Rundering</span> <span
							...
							<div class="direct-chat-text">신속 깨끗하게 처리해서 집 앞까지 확실히 가져다
								드리겠습니다!</div>
				...
				<div class="card">
					...
					<div class="card-body p-0">
						<ul class="users-list clearfix" style="height: 250px;">
							<li><img src="dist/img/user1-128x128.jpg" alt="사진넣을곳">
								<a class="users-list-name" href="#">사진</a> <span
