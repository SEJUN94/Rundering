			...
			<div class="card card-body">
				<div class="col-md-12 ">
					<div class="form-group col-12">
						...
						<button class="btn btn-xs btn-secondary" onclick="location.href='<%=request.getContextPath()%>/admin/branchapplication/file/filedownload?atchFileNo={{leasecontractFile}}&bizType=임대차계약서'" type="button"  style="background-color:#82BBD8;border: 1px solid #82BBD8">
