			...
			<div class="card card-body">
				<div class="col-md-12 ">
					<div class="form-group col-12">
						...
						<button class="btn btn-xs btn-secondary" onclick="location.href='<%=request.getContextPath()%>/admin/branchapplication/file/filedownload?atchFileNo={{application.leasecontractFile}}&bizType=임대차계약서'"
