				...
				<table style="text-align: center;" class="table text-nowrap">
					...
					<tbody>
						<c:if test="${empty appList  }">
							<tr>
								<td colspan="5" style="vertical-align: middle;"><strong>해당
										내용이 없습니다.</strong></td>
							</tr>
						</c:if>
						<c:forEach items="${appList }" var="list">
							<tr>
								<td class="list" id="memno" name="memno"
									value="${list.memberNo}">${list.memberNo}</td>
								...
								<td><button type="submit" class="btn btn-danger btn-sm"
										onclick="remove('${list.memberNo}')">반려</button></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
			...
			<form class="form-horizontal" method="post">
				<div class="card-body">
					<div class="row">
						<div class="col-md-6">
							<div class="form-group mb-1" style="display: flex;">
								<label class="col-2 mt-2 ml-3">이름</label> <input type="text"
									class="form-control" id="name" name="name" value="" readonly />
							</div>
							<div class="form-group mb-1" style="display: flex;">
								<label class="col-2 mt-2 ml-3">연락처</label> <input type="text"
									class="form-control" id="phone" name="phone" value="" readonly />
							</div>
							<div class="form-group mb-1" style="display: flex;">
								<label class="col-2 mt-2 ml-3">이메일</label> <input type="text"
									class="form-control" id="email" name="eamil" value="" readonly />
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group mb-1" style="display: flex;">
								<label class="col-2 mt-2 ml-3">지점</label> <input type="hidden"
									class="form-control" id="branchCode" name="branchCode"
									value="${bv.branchCode }" readonly> <input type="text"
									class="form-control" value="${bv.branchName }" readonly>
							</div>
							<div class="form-group mb-1" style="display: flex;">
					...
					<input type="hidden" id="memNo" name="memNo" value=""> <input
						type="hidden" id="jd" name="jd" value="">
					<div class="form-group" style="">
						<div class="float-right col-2 p-0" style="margin-right: 0;">
							<button onclick="regist()" class="btn col-12 btn-primary"
								type="submit"
								style="background-color: #82BBD8; border: 1px solid #82BBD8">등록</button>
						</div>
					</div>
				</div>
			</form>
