		...
		<div class="card-header" style="">
			...
			<div class="card-tools">
				<button type="button" class="btn btn-tool p-3"
					data-card-widget="remove" title="Remove" style="">
			...
			<div class="row">
				...
				<div class="col-12 col-md-12 col-lg-4 order-1 order-md-2">
					<div class="text-muted">
						<p class="text-lg p-2">
							배송 요청일 <b class="d-block">2022-03-31</b>
						</p>
						<p class="text-lg p-2">
							주소지 <b class="d-block">중구 동서대로1340번길 46</b> <b class="d-block">대덕빌라
								105호</b>
						</p>
						<p class="text-lg p-2">
							배송 세탁물 <b class="d-block">와이셔츠 1개</b> <b class="d-block">티셔츠
								2개</b> <b class="d-block">니트 1개</b>
						</p>
					</div>
				</div>
			</div>
