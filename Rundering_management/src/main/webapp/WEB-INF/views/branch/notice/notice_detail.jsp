			...
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					...
					<div class="modal-footer">
						<button type="button" class="btn btn-warning" id="modifyBtn" data-replyno onclick="replyModify()" style="background-color:#82BBD8; border: 1px solid #82BBD8;">작성</button>
						<button type="button" class="btn btn-warning" data-dismiss="modal" style="background-color:#82BBD8; border: 1px solid #82BBD8;">닫기</button>
					</div>
				</div>
			</div>
		</div>
