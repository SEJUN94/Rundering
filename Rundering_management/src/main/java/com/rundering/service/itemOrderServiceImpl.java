...
public class itemOrderServiceImpl implements ItemOrderService{
	...
	public Map<String, Object> getItemOrderDetailList(String ordercode) throws SQLException {
		Map<String, Object> dataMap = new HashMap<String, Object>();
		//주문정보
		ItemOrderVO itemOrder = itemOrderDAO.selectItemOrderDetail(ordercode);
		//물품발주 상세품목
		List<ItemOrderDetailVO> itemOrderDetail = itemOrderDAO.selectItemOrderDetailList(ordercode);
	...
	public void modifyStatus(ItemOrderVO itemOrder) throws SQLException {
		itemOrderDAO.modifyStatus(itemOrder);
	}
